    ...
    if (sceneJson.contains("Entities")) {
        ...
        for (auto& entityJson : entitiesJson) {
            ...
            if (!relationshipComponentJson.is_null()) {
                ...
                if (parentUUID != 0) {
                    ...
                    if (parentEntity != entt::null) {
                        ...
                        // TODO[SceneSerializer]: Implement handling of forward references when deserializing parent-child relationships to ensure proper hierarchy reconstruction
                    }
                }
            }
            ...
            if (entityJson.contains("Camera2DComponent") && !entityJson["Camera2DComponent"].is_null()) {
                ...
                c2d.Background  = j["Background"].get<glm::vec4>();
            }
