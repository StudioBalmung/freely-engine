...
Texture2D::Texture2D(const std::string& path) {
    ...
    // Mipmaps intentionally omitted: nearest-neighbor pixel art at fixed
    // scale gains nothing from mipmapping, and mip generation bleeds colors
    // across adjacent frames in the same sprite-sheet atlas.
