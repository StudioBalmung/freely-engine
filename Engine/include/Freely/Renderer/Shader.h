...
public:
    ...
    bool Reload(const std::string& vertexSource, const std::string& fragmentSource);
    bool ReloadFromFile(const std::string& vertexPath, const std::string& fragmentPath);
    ...
    static std::shared_ptr<Shader> CreateFromFileWithFallback(
...
private:
    ...
    std::shared_ptr<ShaderFileInfo> m_FileInfo;
