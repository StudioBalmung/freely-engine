...
// ECS ISystem that:
//   1. OnCreate: creates physics bodies for every RigidBodyComponent + ColliderComponent
//   2. OnFixedUpdate: steps the simulation
//   3. After step: reads body transforms back into TransformComponent
//   4. OnDestroy: destroys all physics bodies
